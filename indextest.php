...
<html class="no-js">
  ...
  ================================================== -->
        ...
        <!-- Styling for the CSS-only Carousel-->
        <link type="text/css" href="/Template/css/css-onlyCarousel.css" rel="stylesheet">
                ...
                <header class="site-header">
                    <div class="container">
                        <div class="site-logo">
                           ...
                           <a href="/Template/index.php"><span>A&M Landscaping</span></a>
